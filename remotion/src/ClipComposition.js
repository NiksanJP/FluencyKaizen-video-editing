 ...
 */
export const ClipComposition = ({ clipData: propClipData, clipName }) => {
    ...
    return (_jsxs("div", { style: {
            ...
            overflow: "hidden",
                    ...
                    minHeight: "100%",
                    objectFit: "contain",
                } }), _jsx(HookTitle, { title: clipData.hookTitle }), _jsx(Sequence, { from: 0, durationInFrames: durationInFrames, children: _jsx(BilingualCaption, { subtitles: clipData.subtitles, clipStart: clipData.clip.startTime, targetLanguage: clipData.targetLanguage, onCaptionBottom: handleCaptionBottom }) }), clipData.vocabCards.slice(0, styleConfig.vocabCard.maxCount).map((card, idx) => (_jsx(Sequence, { from: Math.floor((card.triggerTime - clipData.clip.startTime) * fps), durationInFrames: Math.floor(card.duration * fps), children: _jsx(VocabCard, { card: card, top: vocabTop }) }, idx)))] }));
};
//# sourceMappingURL=ClipComposition.js.map
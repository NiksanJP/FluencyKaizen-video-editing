...
const TimelineComposition = ({ tracks = [], fallbackTitle, playerTotalFrames }) => {
  const frame = useCurrentFrame();
...
export { TimelineComposition, ActiveClipMedia, getTrackLayerZ, calculateFittedDimensions, getClipSource, clamp, parseNumeric, resolveNumericDimension, getFontWeightNumber };
